...
class ModelArguments:
    ...
    add_lora: bool = field(
        ...
        metadata={
            "help": (
                "Whether to add LoRA to the model. If set to True, LoRA will be added to the model."
            )
        },
    )
...
def main():
    ...
    if model_args.add_lora:
        lora_config = LoraConfig(
            ...
            target_modules=["c_attn", "c_proj", "c_fc"],  # For GPT-2, target attention and MLP modules
            # For LLaMA models, you might use: ["q_proj", "v_proj", "k_proj", "o_proj", "gate_proj", "up_proj", "down_proj"]
        )
