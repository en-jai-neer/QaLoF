...
class ModelArguments:
    ...
    eval_bit_width: Optional[int] = field(
        default=8,
        metadata={
            "help": (
                "The bit width to use for evaluation. If not specified, will use the default bit width."
...
def main():
    ...
    trainer = AdaptiveLoRATrainer(
        ...
        current_bit_width=model_args.eval_bit_width,
    )
