...
class ModelArguments:
    ...
    num_cyclic_period: Optional[int] = field(
        ...
        metadata={
            "help": (
                "The number of cyclic periods for the cyclic learning rate schedule. If not specified, will use the default value."
                " This should be an integer."
            )
        },
    )
...
def main():
    ...
    trainer = AdaptiveLoRATrainer(
        ...
        num_cyclic_period=model_args.num_cyclic_period,
        bit_widths=model_args.bit_widths,
    )
    ...
    for name, param in model.named_parameters():
        if 'lora' in name.lower():
            ...
            # print(f"Unfreezing: {name} - {param.numel()} parameters")
        else:
